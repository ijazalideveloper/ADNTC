...
export default function TasksPage() {
  ...
  const fetchTasks = async () => {
    ...
    try {
      // Get all tasks, filtering will be done in the TaskList component
      ...
      if (response.success && response.data) {
        ...
        const newTask = {
          ...
          createdAt: response.data.task.createdAt
            ? new Date(response.data.task.createdAt)
            : new Date(),
          ...
          id:
            ...
            (response.data.task._id ? response.data.task._id.toString() : ""),
        };
    ...
    <div>
      <div className={styles.pageHeader}>
        ...
        <p className={styles.pageDescription}>
          View and manage all your tasks. Create new tasks, edit existing ones,
      ...
      <TaskList
        ...
        isLoading={loading}
        // Default filter to show all tasks
        defaultFilters={{
          status: "all",
          priority: "all",
